...
WORKDIR /go/src/github.com/Click2Cloud/libcompose
...
ENV COMPOSE_BINARY /go/src/github.com/Click2Cloud/libcompose/libcompose-cli
ENV USER root

# Wrap all commands in the "docker-in-docker" script to allow nested containers
ENTRYPOINT ["hack/dind"]

COPY . /go/src/github.com/Click2Cloud/libcompose
